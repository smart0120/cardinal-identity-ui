...
This repository hosts the UI inteface and UI components for building identity tokens into dApps. It also maintains a deployment for for our Twitter linking flow https://twitter.cardinal.so

Use this repo to link identity tokens to your wallet, or drop the UI components into your app for ease of use and global identity.
...
The main UI can be accessed at https://twitter.cardinal.so. Use this UI as a simple interface to link and unlink twitter profiles. Each profile is represented as a generated NFT generated by https://github.com/cardinal-labs/cardinal-generators.

To use the UI components, take a look at the getting started.
...
This documentation should give a high level overview of how to incorporate cardinal-identity-ui into your dApp.

The UI has the following components for
...
- Hooks to directly lookup mapping from wallet to name and reverse and use this data in your app. All hooks come with loading state for smooth build-ins
