...
export const IDENTITIES: {
  ...
  github: {
    ...
    verificationUrl: () =>
      `https://github.com/login/oauth/authorize?client_id=6dde2e3b686c463e419e&redirect_uri=https://github.cardinal.so/verification?identity=github&read:user&state=15773059ghq9183habn&allow_signup=false`,
    verifierUrl: (address, proof, accessToken, cluster, dev) => {
      const code = new URL(proof).searchParams.get('code')
      return `${apiBase(
        dev
